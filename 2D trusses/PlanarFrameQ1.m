...
Link_i = [1:NSpokes 1:NSpokes]'; % Start points
% spokes start at outer points, connecting links start where spokes start
Link_j = [ones(1,NSpokes)*NJoints 2:NSpokes 1]'; % End points
...
% signing joint numbers
plot(Joint_xD,Joint_yD,'k.','markersize',15);
for kJoint = 1:NJoints 
